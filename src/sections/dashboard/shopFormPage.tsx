...
export default function CreateShop({ user }: { user: Seller }) {
  ...
  const createShopMutation = useMutation({
    ...
    onSuccess: (shop) => {
      ...
      query.setQueryData(['seller', user.id], (data: Seller) => {
        return {
          ...data,
          selectedShop: shop,
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    createShopMutation.mutate({ ...values, sellerId: user.id });
  };
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          This is the name of your shop that will be displayed
                          to the public.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          ...
                          replaced by underscores. Once you create your shop,
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          This is the cover of your shop. Make sure it has a
                          good resolution and good quality.
                        </FormDescription>
